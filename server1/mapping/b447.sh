#!/bin/bash
 ...
 tc qdisc add dev eth0 parent 1:1 handle 10: netem delay 2ms
 tc filter add dev eth0 protocol ip parent 1:0 u32 match ip dst 10.0.1.144 flowid 1:1
 ...
 tc filter add dev eth0 protocol ip parent 1:0 u32 match ip dst 10.0.1.193 flowid 1:2
 ...
 tc filter add dev eth0 protocol ip parent 1:0 u32 match ip dst 10.0.1.195 flowid 1:3
 ...
 tc filter add dev eth0 protocol ip parent 1:0 u32 match ip dst 10.0.1.244 flowid 1:4
