#!/bin/bash
 ...
 tc filter add dev eth0 protocol ip parent 1:0 u32 match ip dst 10.0.0.125 flowid 1:1
 ...
 tc filter add dev eth0 protocol ip parent 1:0 u32 match ip dst 10.0.0.174 flowid 1:2
 ...
 tc filter add dev eth0 protocol ip parent 1:0 u32 match ip dst 10.0.0.176 flowid 1:3
 ...
 tc filter add dev eth0 protocol ip parent 1:0 u32 match ip dst 10.0.0.225 flowid 1:4
