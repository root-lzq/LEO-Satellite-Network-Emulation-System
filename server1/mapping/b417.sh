#!/bin/bash
 ...
 tc filter add dev eth0 protocol ip parent 1:0 u32 match ip dst 10.0.1.114 flowid 1:1
 ...
 tc filter add dev eth0 protocol ip parent 1:0 u32 match ip dst 10.0.1.163 flowid 1:2
 ...
 tc filter add dev eth0 protocol ip parent 1:0 u32 match ip dst 10.0.1.165 flowid 1:3
 ...
 tc filter add dev eth0 protocol ip parent 1:0 u32 match ip dst 10.0.1.214 flowid 1:4
