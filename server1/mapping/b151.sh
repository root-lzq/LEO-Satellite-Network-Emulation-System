#!/bin/bash
 ...
 tc filter add dev eth0 protocol ip parent 1:0 u32 match ip dst 10.0.0.102 flowid 1:1
 ...
 tc filter add dev eth0 protocol ip parent 1:0 u32 match ip dst 10.0.0.153 flowid 1:2
 ...
 tc filter add dev eth0 protocol ip parent 1:0 u32 match ip dst 10.0.0.201 flowid 1:3
 tc class add dev eth0 parent 1: classid 1:4 htb rate 10mbit ceil 10mbit
 tc qdisc add dev eth0 parent 1:4 handle 40: netem delay 0ms
 tc filter add dev eth0 protocol ip parent 1:0 u32 match ip dst 10.0.0.202 flowid 1:4
