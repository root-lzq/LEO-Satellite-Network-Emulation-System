#!/bin/bash
 ...
 tc filter add dev eth0 protocol ip parent 1:0 u32 match ip dst 10.0.0.140 flowid 1:1
 ...
 tc filter add dev eth0 protocol ip parent 1:0 u32 match ip dst 10.0.0.189 flowid 1:2
 ...
 tc filter add dev eth0 protocol ip parent 1:0 u32 match ip dst 10.0.0.191 flowid 1:3
 ...
 tc filter add dev eth0 protocol ip parent 1:0 u32 match ip dst 10.0.0.240 flowid 1:4
